...
export default {
	...
	plugin: (markdownIt: MarkdownIt) => {
		...
		markdownIt.renderer.rules.table_open = function(tokens: MarkdownIt.Token[], idx: number, options: MarkdownIt.Options, env: unknown, renderer: MarkdownIt.Renderer) {
		...
		markdownIt.renderer.rules.table_close = function(tokens: MarkdownIt.Token[], idx: number, options: MarkdownIt.Options, env: unknown, renderer: MarkdownIt.Renderer) {
